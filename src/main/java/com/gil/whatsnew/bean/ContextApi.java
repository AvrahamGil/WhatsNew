...
public class ContextApi {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ContextApi other = (ContextApi) obj;
		if (body == null) {
			if (other.body != null)
				return false;
	...
	public String toString() {
		return "Article [title=" + title + ", url=" + url + ", description=" + description + ", body=" + body
				+ ", keyword=" + keyword + ", language=" + language + ", isSafe=" + isSafe + ", image=" + image
